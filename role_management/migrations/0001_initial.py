...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='RALevel',
            fields=[
                ('role_assignment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='role_management.roleassignment', verbose_name='Role Assignment')),
                ('name', models.CharField(max_length=50, verbose_name='Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_number', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message="شماره تلفن باید با فرمت '1234567-021' وارد شود. حداکثر ۱۵ رقم مجاز است.", regex='^\\d{3}-\\d{5}$')], verbose_name='Home Number')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
            ],
        ),
