    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Description')),
                ('score', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Score')),
                ('individual_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='individual_course_management.course', verbose_name='Individual Course')),
            ],
        ),
        migrations.CreateModel(
            name='CourseEnroll',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contents', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='individual_course_management.content', verbose_name='Contents')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='individual_course_management.template', verbose_name='Template')),
            ],
        ),
    ]
